...
class HoneywellScannerPage extends StatefulWidget {
  const HoneywellScannerPage({super.key});

  @override
  State<HoneywellScannerPage> createState() => _HoneywellScannerPageState();
}

class _HoneywellScannerPageState extends State<HoneywellScannerPage> with WidgetsBindingObserver
    implements ScannerCallback {
  //WidgetsBindingObserver => observar cambios en el ciclo de vida suscribirme a didChangeAppLifecycleState
  // manejar los eventos relacionados con el escáner.
